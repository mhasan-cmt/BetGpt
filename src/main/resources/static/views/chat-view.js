...
<div id="message-input" class="absolute bottom-0 left-0 w-full mx-auto py-6 border-t border-gray-300 bg-white bg-opacity-70 backdrop-blur-sm backdrop-filter">
  <form class="relative block mx-auto max-w-3xl">
    ...
    <textarea name="message" id="message" placeholder="팀1 vs 팀2, 경기종류, 누가 이김?" class="w-full resize-none rounded-md border border-gray-300 focus:border-gray-300 shadow-md text-gray-900 focus:ring-0 focus:ring-offset-0 placeholder:text-gray-400 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
...
<div id="message-input" class="absolute bottom-0 left-0 w-full mx-auto py-6 border-t border-gray-300 bg-white bg-opacity-70 backdrop-blur-sm backdrop-filter">
  <form class="relative block mx-auto max-w-3xl">
    <!-- <textarea name="message" id="message" class="w-full resize-none rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:py-1.5 sm:text-sm sm:leading-6"></textarea> -->
    <textarea name="message" id="message" placeholder="Golden State Warriors vs LA Lakers, NBA, who would win?" class="w-full resize-none rounded-md border border-gray-300 focus:border-gray-300 shadow-md text-gray-900 focus:ring-0 focus:ring-offset-0 placeholder:text-gray-400 sm:py-1.5 sm:text-sm sm:leading-6"></textarea>
  </form>
</div>
`
  ...
  #createChatMessageEl (chatMessage) {
    ...
    dt.innerHTML = `<chatty-icon name="${iconName}" class="mx-auto h-6 w-6" style="display:block"/>`
    ...
    //chatMessage.content.length != 4532 || chatMessage.content.split(" ")[0] != "Ignore"
